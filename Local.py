...
def generate_frames(skip_frames=5, target_resolution=(640, 640)):
    global cap, current_frame
...
def convert_predictions_to_rects(results):
    ...
    print(f"Car rects: {car_rects}, Free rects: {free_rects}")
...
def draw_boxes_and_ids(frame, car_trackers, free_trackers):
    ...
    line_positions = [(int(frame_width * 0.75), frame_height), (int(frame_width * 0.85), frame_height)]
